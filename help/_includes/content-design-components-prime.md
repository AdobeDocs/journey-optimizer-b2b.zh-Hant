---
title: 內容製作 — 元件(Prime)
description: 在Journey Optimizer B2B Prime中使用元件和內容元素進行內容製作的相關章節已重複使用
...
1. 若要開始您的內容設計，請從&#x200B;**[!UICONTROL 結構]**&#x200B;拖曳一個專案，然後將其放到畫布上。
   ...
   如需使用和格式化這些元件的詳細資訊，請參閱&#x200B;_[結構元件](../prime/content/structure-components.md)_。
...
1. 展開&#x200B;**[!UICONTROL 內容]**&#x200B;區段，並視需要新增內容元件至一或多個結構元件。
   ...
   * [按鈕](../prime/content/content-components.md#button)
   * [文字](../prime/content/content-components.md#text)
   * [分隔線](../prime/content/content-components.md#divider)
   * [影像](../prime/content/content-components.md#image)
   * [社交](../prime/content/content-components.md#social)
   * [表單](../prime/content/content-components.md#form) （僅登入頁面）
