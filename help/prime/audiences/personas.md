...
Journey Optimizer B2B Prime會針對已定義的角色評估記錄的屬性，以衍生每個人員記錄的角色。 定義人員清單或人員歷程的對象時，您可以使用推斷的結果（_衍生角色_）作為篩選器。

_[!UICONTROL 衍生角色]_&#x200B;篩選器會顯示在&#x200B;**[!UICONTROL 人員屬性]**&#x200B;類別下的篩選器面板中。

![存取設定的角色](../../user/admin/assets/configuration-persona-mapping.png){width="800" zoomable="yes"}
