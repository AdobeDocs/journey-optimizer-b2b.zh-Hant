...
|---|---|---|---|---|
| `falco-program-creation` | 端對端[!DNL Journey Optimizer B2B Prime]方案建立 — 方案、子資料夾、權杖、清單、歷程。 | 寫入 | [!DNL Journey Optimizer B2B Prime] | 讀取+寫入[!DNL Journey Optimizer B2B Prime]。 請參閱&#x200B;_[從簡報建立方案](./program-from-brief.md)_。 |
...
| 技能 | 作用 | 存取權 | 產品 | 後端（資料流程） |
|---|---|---|---|---|
| `audience-creation` | 調整[!DNL Marketo Engage]智慧清單、建立人員清單或新增/更新規則。 | 寫入 | [!DNL Journey Optimizer B2B Prime] | 讀取[!DNL Marketo Engage] +讀取/寫入[!DNL Journey Optimizer B2B Prime]。  請參閱&#x200B;_[建立方案的對象](./audience-creation.md)_。 |
...
| 技能 | 作用 | 存取權 | 產品 | 後端（資料流程） |
|---|---|---|---|---|
| `scoring-studio` | 列出/取得評分模型並建置/發佈。 | 讀取+寫入 | [!DNL Journey Optimizer B2B Prime] | 讀取+寫入[!DNL Journey Optimizer B2B Prime] （評分服務）；讀取[!DNL Marketo Engage]潛在客戶欄位/活動型別。 請參閱&#x200B;_[建立自訂評分模型](./lead-scoring-model.md)_。 |
