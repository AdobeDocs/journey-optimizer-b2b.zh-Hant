---
title: 結構元件
description: 將結構元件用於電子郵件、登陸頁面和片段配置。 在Journey Optimizer B2B Prime中拖曳欄、設定樣式及設定行動顯示。
...
![結構元件工具列](../../user/assets/do-not-localize/toolbar-structure.png){width="150"}

| 工具 | 名稱 | 使用情況 |
| ---- | ---- | ----- |
| ![啟用條件式內容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 啟用條件式內容 | （電子郵件和片段）啟用元件的條件變體。 |
| ![選取資料行](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | 選取欄 | 依數字選取欄。 選取欄時，您可以套用欄設定和樣式。 |
...
![顯示結構元件](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}的選項
...
![結構元件設定為標頭](../../user/content/assets/structure-component-settings-header.png){width="600" zoomable="yes"}
...
![請勿在行動裝置上棧疊欄](../../user/content/assets/structure-component-settings-stack-columns.png){width="250"}
...
![使用資產選擇器的結構元件背景影像設定](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
![結構元件上的背景影像位置預覽](../../user/content/assets/structure-component-styles-background-image.png){width="250"}
...
![欄工具列](../../user/assets/do-not-localize/toolbar-column.png){width="500"}

| 工具 | 名稱 | 使用情況 |
| ---- | ---- | ----- |
| — | 清除欄 | 清除欄中的內容。 請參閱欄工具列中的第一個工具。 |
| ![啟用條件式內容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 啟用條件式內容 | （電子郵件和片段）啟用欄的條件變體。 |
| ![選取資料行](../../user/assets/do-not-localize/toolbar-button-column-select.png){width="100"} | 選取欄 | 依數字選取欄。 選取欄時，您可以套用設定和樣式。 |
...
![欄數設定](../../user/content/assets/structure-components-n-n-columns-number.png){width="650" zoomable="yes"}

在畫布中，移動欄大小圖示以調整所選欄的寬度。 當您增加或減少寬度時，相鄰的欄也會調整，讓所有欄都佔據100%的元件寬度。

![調整資料行大小](../../user/content/assets/structure-components-n-n-columns-resize.png){width="500" zoomable="yes"}
...
* **[!UICONTROL 背景影像]** — 移動切換選擇器以啟用背景影像設定。
  ...
  樣式面板中的![欄背景影像設定](../../user/content/assets/structure-components-background-image-settings.png){width="250"}
...
在視覺化設計空間中，您可以使用導覽樹來存取結構元件，包括欄和內容。 按一下左側的&#x200B;_[!UICONTROL 導覽樹狀結構]_&#x200B;圖示（![導覽樹狀結構圖示](../../user/assets/do-not-localize/icon-navigation-tree.svg)）以顯示樹狀結構。
