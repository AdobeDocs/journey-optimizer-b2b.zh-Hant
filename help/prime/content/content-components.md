---
title: 內容元件
description: 在Journey Optimizer B2B Prime中設計包含內容元件的電子郵件、登入頁面和片段 — 新增按鈕、文字、影像、表單和容器。
...
![內容元件工具列](../../user/assets/do-not-localize/toolbar-content.png){width="450"}
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-text-styles.png" alt="變更文字樣式工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-horizontal-alignment.png" alt="水準對齊工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-create-list.png" alt="建立清單工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-set-heading.png" alt="設定標題工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-font-size.png" alt="字型大小工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-font-color.png" alt="字型顏色工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-insert-link.png" alt="插入連結工具"></td>
...
<table>
    ...
    <tr>
        <td><img width="80px" src="../../user/assets/do-not-localize/toolbar-button-remove-link.png" alt="移除連結工具"></td>
...
| 工具 | 名稱 | 使用情況 |
| ---- | ---- | ----- |
| ![新增個人化](../../user/assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} | 新增個人化 | 使用個人化編輯器在元件內容中插入個人化代號。 [了解更多](./email-authoring.md#personalize-content) |
| ![顯示原始程式碼](../../user/assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | 顯示原始程式碼 | 以唯讀快顯視窗顯示元件的HTML原始碼。 <br/>![顯示HTML程式碼](../../user/content/assets/content-components-show-source-code.png){width="200"} |
| ![啟用條件式內容](../../user/assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | 啟用條件式內容 | （電子郵件和片段）啟用元件的條件變體。 |
| ![複製](../../user/assets/do-not-localize/toolbar-button-duplicate.png){width="40"} | 重複 | 建立元件的復本，並直接將其新增到下方。 |
| ![刪除](../../user/assets/do-not-localize/toolbar-button-delete.png){width="40"} | 刪除 | 移除元件。 |
...
1. 在&#x200B;**[!UICONTROL 元件]**&#x200B;資料庫中，抓取您所選內容元件的&#x200B;_拖曳控點_ ![拖曳控點](../../assets/do-not-localize/icon-drag-handle.svg)，然後將其拖放到結構元件上。
   ...
   ![將內容元件拖曳至結構元件](../../user/content/assets/content-components-drag.png){width="600" zoomable="yes"}

1. 使用右側的&#x200B;**[!UICONTROL 設定]**&#x200B;和&#x200B;**[!UICONTROL 樣式]**&#x200B;標籤，或畫布中顯示的內容工具列，調整元件顯示。

   例如，您可以變更元件的文字樣式、邊框間距或邊界。

   ![定義內容元件的設定和樣式](../../user/content/assets/content-components-settings-styles.png){width="600" zoomable="yes"}
...
![內容元件的顯示選項](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![容器內容元件樣式](../../user/content/assets/content-components-container.png){width="600" zoomable="yes"}
...
與工具列](../../user/content/assets/content-components-button.png){width="500" zoomable="yes"}一起顯示的![按鈕元件
...
1. 設定連結的&#x200B;**[!UICONTROL 型別]**：
   ...
   * **[!UICONTROL 外部連結]** — 選擇此型別以使用標準URL作為連結目的地。
     ...
     在&#x200B;**[!UICONTROL Url]**&#x200B;中，輸入連結目的地的URL。 按一下「_個人化_」（「![個人化圖示](../../user/assets/do-not-localize/icon-personalize.svg)」）圖示，使用個人化權杖作為URL中的引數。

     ![定義按鈕元件的外部連結](../../user/content/assets/component-button-link-options-external.png){width="200"}

   * **登陸頁面** — 選擇此型別，在<!-- Journey Optimizer B2B Edition (_Beta_) or -->連線的Marketo Engage執行個體中選取已發佈的登陸頁面。

     針對&#x200B;**[!UICONTROL 登陸頁面]**&#x200B;選項，請選取已發佈的登陸頁面。 按一下&#x200B;_選取頁面_&#x200B;圖示（![顯示連結圖示](../../user/assets/do-not-localize/icon-landing-page-select.svg)）和[選取已發佈的登陸頁面](./landing-pages.md#link-to-landing-page)。

     ![定義按鈕元件登入頁面的連結](../../user/content/assets/component-button-link-options-landing-page.png){width="200"}
...
1. 在畫布上選取元件，然後按一下工具列中的「_顯示原始程式碼_」圖示。
   ...
   ![開啟程式碼編輯器以新增HTML](../../user/content/assets/content-components-html-show-code.png){width="450"}

1. 在文字方塊中貼上HTML，然後按一下[儲存]。****

   ![編輯HTML對話方塊](../../user/content/assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"}
...
![與工具列一起顯示的影像元件](../../user/content/assets/content-components-image.png){width="400" zoomable="yes"}

#### 新增影像資產 {#add-image-asset}

選擇要新增影像資產的方法：

* **[!UICONTROL 選取資產]** — 選擇此型別以瀏覽並從[!DNL Journey Optimizer B2B Prime] Assets資料庫中選取影像資產。
...
* **[!UICONTROL 匯入媒體]** — 選擇此型別以從您的系統選取檔案，並將其匯入[!DNL Journey Optimizer B2B Prime]資產庫。
  ...
  ![將影像檔案匯入資產庫](../../user/content/assets/email-designer-image-upload.png){width="450"}
...
1. 設定連結的&#x200B;**[!UICONTROL 型別]**：
   ...
   * **[!UICONTROL 外部連結]** — 選擇此型別以使用標準URL作為連結目的地。
     ...
     ![定義影像元件的外部連結](../../user/content/assets/component-button-link-options-external.png){width="250"}

   * **登陸頁面** — 選擇此型別，在<!-- Journey Optimizer B2B Edition (_Beta_) or -->連線的Marketo Engage執行個體中選取已發佈的登陸頁面。

     針對&#x200B;**[!UICONTROL 登陸頁面]**&#x200B;選項，請選取已發佈的登陸頁面。 按一下&#x200B;_選取頁面_&#x200B;圖示（![顯示連結圖示](../../user/assets/do-not-localize/icon-landing-page-select.svg)）和[選取已發佈的登陸頁面](./landing-pages.md#link-to-landing-page)。

     ![定義影像元件登入頁面的連結](../../user/content/assets/component-button-link-options-landing-page.png){width="250"}
...
1. 如果您要覆寫表單的預設&#x200B;**[!UICONTROL 後續追蹤型別]**，請根據您的頁面或範本需求變更設定。
   ...
   * **[!UICONTROL 登陸頁面]** — 選擇此選項可選取任何[!DNL Journey Optimizer B2B Prime]或Marketo Engage登陸頁面作為後續追蹤。
