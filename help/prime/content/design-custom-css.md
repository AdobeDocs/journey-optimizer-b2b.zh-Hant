---
title: 為內容新增自訂CSS
description: 新增自訂CSS至電子郵件和登陸頁面，Journey Optimizer B2B Prime中的標準元件無法提供進階樣式和精確設計控制。
...
1. 選取右側的&#x200B;_樣式_&#x200B;索引標籤，然後按一下&#x200B;**[!UICONTROL 新增自訂CSS]**。
   ...
   ![存取內文樣式](../../user/content/assets/email-body-styles.png){width="800" zoomable="yes"}
...
1. 按一下[儲存]儲存自訂CSS。****
   ...
   ![套用至內容的自訂CSS](../../user/content/assets/email-body-custom-css-applied.png){width="600" zoomable="yes"}
