...
# Journey Optimizer B2B Prime使用手冊 {#prime}
...
+ AI 助理 {#ai-assistant}
  ...
  + [建立方案的對象](./agents/audience-creation.md)
  + [建立自訂評分模型](./agents/lead-scoring-model.md)
+ [AI決策](./agents/ai-decisioning.md)
+ 行銷管理 {#marketing-management}
  + [概觀](./marketing/marketing-management.md)
  + 方案 {#programs}
    + [概觀](./marketing/programs.md)
    + [適用於個人化的自訂權杖](./marketing/personalization-my-tokens.md)
  + [個人歷程](./marketing/person-journeys.md)
  + 歷程畫布和節點 {#journey-nodes}
...
+ [歷程流量控制](./marketing/journey-traffic-control.md)
+ 客群 {#audiences}
  + [人員清單](./audiences/people-lists.md)
  + [人員詳細資料](./audiences/person-details.md)
...
+ 內容 {#content}
  + [資產](./content/digital-asset-management.md)
  + 範本 {#templates}
