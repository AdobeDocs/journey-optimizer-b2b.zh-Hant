...
1. 透過輸入您的Adobe ID電子郵件、使用者名稱、名字或姓氏進行搜尋。
   ...
   * 如果&#x200B;**[!UICONTROL ADMIN ROLE]**&#x200B;欄中的值顯示`System`，則顯示的使用者為系統管理員。
...
>[!TIP]
>
>從舊版部署移轉並新增現有使用者至Marketo Engage時，您可以略過使用者群組建立，而直接開啟現有群組並新增Marketo Engage產品設定檔即可。
...
許可權是統一許可權，可讓您定義指派給產品設定檔的授權。 每個許可權都會分組在功能下，例如&#x200B;_歷程_&#x200B;或&#x200B;_購買群組_。 這些功能代表Journey Optimizer B2B Edition中的函式或物件。
...
| B2B歷程 | 設定、管理、檢視和發佈B2B歷程的許可權。 這些許可權包括帳戶和人員動作、事件接聽程式以及分割路徑。 | <li>管理B2B歷程 |
