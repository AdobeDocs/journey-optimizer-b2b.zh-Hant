...
1. 新增每個使用者：
   ...
   * 輸入使用者的電子郵件地址、名字和姓氏。
     ...
     ![Experience Platform — 新增新角色的使用者設定檔](./assets/admin-console-add-users.png){width="600" zoomable="yes"}
...
1. 按一下B2B歷程資源的&#x200B;_新增_&#x200B;圖示(**+**)。
   ...
   ![Experience Platform - B2B歷程資源已新增至頻道管理員角色](./assets/aep-permissions-role-edit-b2b-journeys-add.png){width="700" zoomable="yes"}

1. 在&#x200B;_[!UICONTROL B2B歷程]_&#x200B;許可權卡中，選取&#x200B;**[!UICONTROL 管理B2B帳戶歷程]**。

1. 按一下&#x200B;**[!UICONTROL 儲存]**。

   ![Experience Platform — 為頻道管理員角色儲存的B2B歷程許可權](./assets/aep-permissions-role-edit-b2b-journeys-done.png){width="700" zoomable="yes"}
...
1. 按一下&#x200B;**[!UICONTROL 新增群組]**。
   ...
   ![Experience Platform — 將群組新增至角色](./assets/aep-permissions-role-add-groups.png){width="700" zoomable="yes"}
...
1. 新增B2B產品許可權：
   ...
   若要決定您想要為角色提供的產品功能，請參閱[B2B產品許可權](#b2b-product-permissions)清單。
...
1. 按一下&#x200B;**[!UICONTROL 新增群組]**。
   ...
   ![Experience Platform — 選取自訂角色的使用者群組](./assets/aep-permissions-role-add-groups.png){width="700" zoomable="yes"}
