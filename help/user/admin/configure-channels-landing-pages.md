...
![管道設定 — 登陸頁面子網域](./assets/config-channels-landing-pages-subdomains.png){width="800" zoomable="yes"}
...
1. 指定要委派的子網域。
   ...
   ![登陸頁面子網域設定](./assets/config-channels-landing-pages-subdomain-setup.png){width="500" zoomable="yes"}
...
1. 請確定DNS記錄已產生到您的網域託管解決方案中。
   ...
   ![設定了DNS記錄的登陸頁面子網域](./assets/config-channels-landing-pages-subdomain-setup-dns.png){width="500" zoomable="yes"}
...
![管道設定 — 登陸頁面預設集](./assets/config-channels-landing-pages-presets.png){width="800" zoomable="yes"}
...
1. 選取登陸頁面子網域。
   ...
   ![包含名稱、說明和子網域的登陸頁面預設集](./assets/config-channels-landing-pages-preset-create.png){width="500" zoomable="yes"}
...
1. 您可以核取&#x200B;**[!UICONTROL 與登陸頁面子網域相同]**&#x200B;選項，以選取&#x200B;**[!UICONTROL 追蹤URL]**&#x200B;的登陸頁面子網域。<!-- [Learn more about tracking](../email/message-tracking.md) -->
   ...
   ![包含子網域設定的登陸頁面預設集](./assets/config-channels-landing-pages-preset-subdomain-settings.png){width="500" zoomable="yes"}
...
1. 按一下&#x200B;**[!UICONTROL 提交]**&#x200B;以確認建立登陸頁面預設集。
   ...
   建立登入頁面預設集後，預設集會顯示在&#x200B;_[!UICONTROL 作用中]_&#x200B;狀態的清單中，且已準備好用於[建立登入頁面](../content/landing-pages-create-publish.md#create-landing-page)。
