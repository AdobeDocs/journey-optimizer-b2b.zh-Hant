...
1. 設定您的SMS API認證：
   ...
   ![設定Sinch SMS API認證](./assets/config-sms-api-sinch.png){width="600" zoomable="yes"}
...
1. 設定您的SMS API認證：
   ...
   ![設定Twilio SMS API認證](./assets/config-sms-api-twilio.png){width="600" zoomable="yes"}
...
1. 設定您的SMS API認證：
   ...
   ![設定Infobip SMS API認證](./assets/config-sms-api-infobip.png){width="600" zoomable="yes"}
