...
![AEP許可權圖示](../../assets/do-not-localize/icon_permissions-outline.svg)這些步驟需要您在Experience Platform中指派的使用者角色的下列[許可權](../admin/user-management.md#b2b-product-permissions)：

* **[!UICONTROL B2B通道設定]** - `Manage B2B Channels`
* **[!UICONTROL Journey Optimizer規則]** - `View Frequency Rules`和`Manage Frequency Rules`
