...
關聯式結構描述可讓您建立自訂資料類別。 您可以存取多個資料集，建立依資料需求量身打造的類別。 在歷程決定和電子郵件個人化中，針對商業實體（例如購買、授權和事件註冊）使用[關聯式結構描述](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/schema/relational#)。 您最多可以選取20個結構描述，以及每個結構描述最多50個欄位。
