...
Adobe Journey Optimizer B2B edition是以Adobe Experience Platform為建置基礎。 透過此實作，Journey Optimizer B2B edition和Marketo Engage並非位於相同系統或相同資料存放區。 Journey Optimizer B2B edition會從Adobe Experience Platform接收資料。 但是，它繼續仰賴Marketo Engage許可權和部分後端功能（例如電子郵件傳送）來布建和設定系統。
...
* **連線多個Adobe Marketo Engage執行個體：**&#x200B;管理和統一來自多個Marketo Engage環境的資料。

* **保護您的資料：**&#x200B;進階的隱私權與安全性功能可協助保護您的客戶資訊。 （_即將推出_）
...
<tbody>
<tr>
<td colspan="2"><strong>標準XDM設定</strong>：設定XDM個人設定檔和XDM商業帳戶結構描述。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="核取方塊"/></td>
...
<tr>
<td colspan="2"><strong>關聯式結構描述</strong>：選取關聯式XDM欄位（帳戶多對一自訂物件）。</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="核取方塊"/></td>
...
若要從[!DNL Journey Optimizer B2B Edition]傳送電子郵件，請在附加的[!DNL Marketo Engage]生產執行個體和[!DNL Journey Optimizer B2B Edition]應用程式中設定電子郵件追蹤與傳遞能力。
