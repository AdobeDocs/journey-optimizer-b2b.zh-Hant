...
AI Assistant介面隨即顯示，立即為您提供開始使用的資訊。 您可以使用&#x200B;_[!UICONTROL Ideas下提供的選項開始使用]_，以回答問題和命令，例如：
...
確保您處於AI助理的有效沙箱中，以便針對有關您營運深入分析的問題提供足夠回應。
...
使用&#x200B;_正面評等_ （![向上縮圖](../assets/do-not-localize/icon-thumb-up.svg) ）或&#x200B;_負面評等_ （![向下縮圖](../assets/do-not-localize/icon-thumb-down.svg) ）圖示來評等回應的實用性和品質。 根據您的經驗填寫簡短的問卷表單，然後按一下&#x200B;**[!UICONTROL 提交]**。 您提供的資訊會用於改善AI助理。
