...
description: 使用AI Assistant加速工作流程 — 取得Journey Optimizer B2B edition的產品知識、疑難排解說明和營運深入分析。
...
Journey Optimizer B2B edition中的AI助理是從Adobe Experience Platform[中](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/ai-assistant/home){target="_blank"}AI助理的相同技術基礎建立的。 這是一種對話式體驗，可用來加速Adobe Journey Optimizer B2B edition的工作流程。 您可以使用AI Assistant進一步瞭解產品功能、疑難排解問題，或透過資訊進行搜尋，並找到Journey Optimizer B2B edition的營運深入分析。
