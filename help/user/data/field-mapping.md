...
>[!TIP]
>
>您可以使用XDM商業帳戶個人關係類別(如[Experience Platform XDM檔案](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/tutorials/relationship-b2b)所述)，以多對多關係來建立XDM商業帳戶和XDM商業帳戶類別的模型。
...
此外，機會資料會儲存為XDM商業機會類別中的屬性，可透過多對一關係與XDM商業帳戶類別建立關聯，如[這裡](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/tutorials/relationship-b2b#relationship-field)所述。
