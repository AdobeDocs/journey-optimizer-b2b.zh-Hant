...
1. [將結構和內容](./landing-page-design.md#structure-content-landing-page)新增到範本。
...
* 清單頁面 — 按一下省略符號(**...**) 在範本旁邊，然後選擇&#x200B;**[!UICONTROL 編輯]**。
...
* 從&#x200B;_[!UICONTROL 登入頁面範本]_&#x200B;清單頁面，按一下省略符號(...) 在範本旁邊，並選擇&#x200B;**[!UICONTROL 複製]**。
...
* 從&#x200B;_登入頁面範本_&#x200B;清單頁面，按一下省略符號(...) 在範本旁邊，然後選擇&#x200B;**[!UICONTROL 刪除]**。
