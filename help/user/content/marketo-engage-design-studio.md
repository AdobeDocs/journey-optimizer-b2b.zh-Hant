...
Marketo Engage Design Studio是Journey Optimizer B2B Edition的預設資產來源，您可以輕鬆管理及使用內容中可供您帳戶歷程使用的資產。

## 瀏覽及存取資產

若要從Adobe Marketo Engage B2B Edition存取Journey Optimizer Design Studio資產，請前往左側導覽並按一下&#x200B;**[!UICONTROL 內容管理]** > **[!UICONTROL Assets]**。 此動作會開啟一個清單頁面，其中列出所有資產。

![瀏覽Marketo Engage資產](assets/assets-list-page.png){width="600" zoomable="yes"}

* 若要依資料夾檢視資產，請按一下左上方的&#x200B;_顯示資料夾_&#x200B;圖示以開啟資料夾結構。
...
參考會依類別顯示： _電子郵件_、_電子郵件範本_&#x200B;或&#x200B;_片段_。 Journey Optimizer B2B Edition中的電子郵件會在歷程中嵌入和編寫，因此使用資產的電子郵件的父歷程會顯示在參考中。

按一下連結，系統會將您導向使用資產的相應電子郵件、電子郵件範本或片段。

## 新增資產

從Assets清單頁面，您可以將影像資產新增至Adobe Marketo Engage Design Studio。

1. 按一下右上方的&#x200B;**[!UICONTROL 新增Assets]**。

1. 在&#x200B;_[!UICONTROL 新增資產]_&#x200B;對話方塊中，將一或多個檔案從您的系統拖放至檔案方塊。

   ![將資產新增至Marketo Engage Design Studio](./assets/assets-add-dialog.png){width="500" zoomable="yes"}
...
* 前往資產詳細資料，按一下&#x200B;**[!UICONTROL ...在右上角顯示[更多]**]，並從選項中選擇[刪除]。****
  ...
  ![存取資產的動作](./assets/assets-details-more-menu.png){width="500" zoomable="yes"}

* 在&#x200B;_[!UICONTROL Assets]_&#x200B;清單頁面上，按一下資產專案旁的&#x200B;_省略符號_ (**[!UICONTROL ...]**)，然後從選項中選擇&#x200B;**[!UICONTROL 刪除]**。

  ![存取資產的動作](./assets/assets-list-file-more-menu.png){width="500" zoomable="yes"}

此動作會開啟確認對話方塊。 您可以按一下&#x200B;**[!UICONTROL 取消]**，或按一下&#x200B;**[!UICONTROL 刪除]**&#x200B;確認刪除，以中止程式。

如果資產目前正在使用中，動作會開啟資訊對話方塊，提醒您無法刪除資產。 按一下&#x200B;**[!UICONTROL 確定]**，這會中止刪除。
...
* 在&#x200B;_[!UICONTROL Assets]_&#x200B;清單頁面上，按一下資產專案旁的&#x200B;_省略符號_ (**[!UICONTROL ...]**)，然後從選項中選擇&#x200B;**[!UICONTROL 取代]**。
...
您可以將動作套用至資料夾或資料夾內的資產。 按一下資料夾的省略符號(**...**)圖示，以顯示資料夾上動作的選項。

![將動作套用至資料夾或資料夾內的資產](./assets/assets-folder-menu-options.png){width="500"}
...
從視覺化編輯器UI中，選取左側邊欄上的&#x200B;_資產選擇器_&#x200B;圖示。

![選取的資產](./assets/content-assets-selector-icon.png){width="700" zoomable="yes"}
...
* 將影像元件新增至畫布，然後按一下&#x200B;**[!UICONTROL 瀏覽]**&#x200B;以開啟&#x200B;_[!UICONTROL 從Adobe Marketo Engage選取資產]_&#x200B;對話方塊。
  ...
  ![使用篩選和搜尋欄位來尋找您需要的資產](./assets/assets-select-dialog-marketo-filtered.png){width="600" zoomable="yes"}
