...
* **[!UICONTROL 購買群組]** — 選擇[購買群組角色](../buying-groups/buying-groups-role-templates.md)，以用於設定您的訊息目標。
...
![影像設定面板顯示產生模型、內容型別、視覺強度、色彩和色調、光線和構成選項](./assets/gen-ai-image-settings.png){width="350" zoomable="yes"}
...
1. 按一下&#x200B;**[!UICONTROL 選取]**&#x200B;以選取的變體取代範本內容，並返回登入頁面設計空間。
...
1. 當您有想要的內容時，請按一下&#x200B;**[!UICONTROL 選取]**&#x200B;以選取的變體取代文字，並返回登陸頁面設計空間。
...
1. 識別最符合您目標的變數，然後按一下&#x200B;_全熒幕_ （ ![全熒幕圖示](../assets/do-not-localize/icon-full-screen.svg) ）圖示以開啟對話方塊。

   ![存取產生對話方塊](./assets/gen-ai-preview-text-refine.png){width="700" zoomable="yes"}
