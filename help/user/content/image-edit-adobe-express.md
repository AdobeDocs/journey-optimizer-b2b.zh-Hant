...
1. 按一下影像資產的名稱以開啟並檢視其詳細資訊。
   ...
   >[!TIP]
   >
   >最佳實務是在影像詳細資料中選取[_[!UICONTROL 使用者]_&#x200B;標籤](./internal-image-assets.md#view-asset-used-by-references)，並檢閱目前使用影像的內容，然後再繼續編輯影像檔案。
...
>[!NOTE]
>
>您的Adobe Express企業授權必須在同一個IMS組織下購買，才能從Journey Optimizer B2B edition存取這些完整的編輯器功能。 身為IMS組織的個別成員，您需要Adobe Express執行個體中的指派授權。 否則，您的Adobe Express存取權僅限於Journey Optimizer B2B edition在Adobe Express](#quick-actions-in-adobe-express)上的[快速動作。
...
* **[!UICONTROL 轉換成JPEG]** — 若是PNG影像，您可以將影像轉換成JPEG影像檔案，並儲存為新資產。
* **[!UICONTROL 轉換成PNG]** — 若是JPEG影像，您可以將影像轉換成PNG影像檔案，並儲存為新資產。
