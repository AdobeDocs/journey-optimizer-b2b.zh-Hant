...
1. **計畫並實作Marketo Engage整合**&#x200B;以合併自訂結構描述、擷取設定檔和帳戶，以及協調購買群組的個人化歷程。 [了解更多](https://experienceleague.adobe.com/zh-hant/docs/blueprints-learn/architecture/b2b-activation/b2b-journeys-with-marketo){target="_blank"}
