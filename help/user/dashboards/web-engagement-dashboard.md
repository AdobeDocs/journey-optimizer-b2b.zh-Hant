---
title: Web參與儀表板
description: 使用頁面檢視分析、地區深入分析和產業細分來分析網站訪客行為，為您的內容策略提供資訊。
...
![Web參與儀表板](./assets/web-engagement-dashboard.png){width="700" zoomable="yes"}

## 篩選資料

按一下左上方的&#x200B;_篩選器_ （![篩選器圖示](../assets/do-not-localize/icon-filter.svg) ）圖示，使用下列任何屬性來篩選顯示的資料：
...
![依帳戶區域的頁面檢視次數](./assets/web-engagement-dashboard-page-views-by-account-region.png){width="500" zoomable="yes"}

## [!UICONTROL 依帳戶產業的頁面檢視次數] {#page-views-by-industry}

>[!CONTEXTUALHELP]
>id="ajo-b2b_web_engagement_page_views_by_industry"
>title="依帳戶產業的頁面檢視次數"
>abstract="依關聯帳戶的產業分類細分的網頁訪客分佈。"
...
![依帳戶產業的頁面檢視次數](./assets/web-engagement-dashboard-page-views-by-account-industry.png){width="500" zoomable="yes"}
