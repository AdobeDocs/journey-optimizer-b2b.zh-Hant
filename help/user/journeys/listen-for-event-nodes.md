...
| 購買群組階段的變化 | 方案興趣<br/>其他限制（選擇性）： <li>新階段</li><li>上一個階段</li><li>活動日期</li><br/>逾時（選擇性） |
| 購買群組狀態的變化 | 方案興趣<br/>其他限制（選擇性）： <li>新狀態</li><li>先前的狀態</li><li>活動日期</li><br/>逾時（選擇性） |
| 完整性分數的變化 | 方案興趣<br/>其他限制（選擇性）： <li>新分數</li><li>前一個分數</li><li>活動日期</li><br/>逾時（選擇性） |
| 參與分數的變化 | 方案興趣<br/>其他限制（選擇性）： <li>新分數</li><li>前一個分數</li><li>活動日期</li><br/>逾時（選擇性） |
...
| | 點按簡訊中的連結 | 電子郵件<br/><br/>其他限制（選擇性）： <li>連結</li><li>裝置</li><li>平台</li><li>活動日期</li><li>最低 次數</li><br/>逾時（選擇性） |
