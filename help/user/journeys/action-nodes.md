...
使用此動作傳送電子郵件。 您可以在視覺化設計工具中建立、個人化及預覽電子郵件訊息（請參閱[電子郵件製作](../content/email-authoring.md)）。 您也可以從Marketo Engage[&#128279;](https://experienceleague.adobe.com/zh-hant/docs/marketo/using/product-docs/email-marketing/general/creating-an-email/create-an-email){target="_blank"}傳送電子郵件。 選取Marketo Engage工作區，然後選取要傳送的電子郵件。
...
>[!VIDEO](https://video.tv.adobe.com/v/3443256/?learn=on&captions=chi_hant)
