...
>[!NOTE]
>
>2025.10版已棄用&#x200B;_[!UICONTROL 帳戶變更資料值]_&#x200B;動作。_[!UICONTROL 更新帳戶設定檔]_&#x200B;取代[簡化架構](../simplified-architecture.md)的這個動作。<br/>
>
...
>[!NOTE]
>
>Marketo Engage中的&#x200B;_[!UICONTROL 變更人員分割]_&#x200B;和&#x200B;_[!UICONTROL 變更分數]_&#x200B;動作在2025.10版本中已過時，並且在Journey Optimizer B2B edition的[簡化架構](../simplified-architecture.md)中無法使用。<br/>
>
...
使用此動作來變更Marketo Engage中的人員分數。[瞭解更多](https://experienceleague.adobe.com/zh-hant/docs/marketo-learn/tutorials/lead-and-data-management/lead-scoring-learn){target="_blank"}
...
>[!NOTE]
>
>_[!UICONTROL 更新人員設定檔]_&#x200B;取代了[簡化架構](../simplified-architecture.md).<br/>中的&#x200B;_[!UICONTROL 變更資料值]_&#x200B;動作
>
