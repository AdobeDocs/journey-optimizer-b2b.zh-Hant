...
| | [!UICONTROL 傳送電子郵件] | <li>帳戶歷程 <li>人員歷程 | <li>建立電子郵件 <li>傳送時間最佳化（選用，僅限個人歷程） |
| | [!UICONTROL 傳送簡訊] | <li>帳戶歷程 | <li>建立簡訊 |
| | [!UICONTROL 傳送WhatsApp] | <li>帳戶歷程 | <li>建立WhatsApp訊息 |
| | [!UICONTROL 更新個人設定檔] | <li>帳戶歷程 <li>人員歷程 | <li>選取人員屬性 <li>設定新值 |
| [Marketo Engage](#marketo-engage-actions) | [!UICONTROL 新增至Marketo要求行銷活動] | <li>帳戶歷程 <li>人員歷程 | <li>選取 Marketo Engage 工作區 <li>選取請求行銷活動 |
...
1. （_僅帳戶歷程_）在右側的節點屬性中，為動作內容選擇&#x200B;**[!UICONTROL 人員]**。
...
+++[!UICONTROL 將人員新增至（其他）歷程]

使用此動作將個人設定檔新增到即時個人歷程。 當人員進入動作節點時，系統會將他們新增為指定人員歷程的對象成員。

使用&#x200B;**[!UICONTROL 選取即時個人歷程]**&#x200B;選取器來指定您想要新增個人設定檔的個人歷程。 您可以在欄位中輸入文字以篩選清單。

![採取動作 — 將人員新增到（其他）歷程](./assets/node-action-add-to-person-journey.png){width="300"}

+++

+++[!UICONTROL 新增至外部客戶對象]

使用此動作將人員推送至外部對象，該對象可以透過付費媒體頻道啟用，以便進一步將目標定位為購買群組的成員。 此動作透過Real-Time CDP B2B edition執行。
...
使用此動作從個人歷程中移除個人設定檔。 當人員進入動作節點時，系統會將其移除，作為指定人員歷程的對象成員。

使用&#x200B;**[!UICONTROL 選取個人歷程]**&#x200B;選取器來指定要移除個人設定檔的個人歷程。 您可以在欄位中輸入文字以篩選清單。

![採取動作 — 將人員從歷程移除](./assets/node-action-remove-from-person-journey.png){width="300"}
