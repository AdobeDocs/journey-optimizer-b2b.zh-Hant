---
title: 帳戶歷程
description: 了解帳戶歷程以及如何建立和管理帳戶歷程。
...
定義由銷售主導的參與過程，包括電子郵件、簡訊以及更多內部帳戶歷程，以便協調每個購買群組成員的集客式行銷和推播式銷售活動。
...
| _**即時**_ | 歷程發佈後，歷程狀態會從「草稿」變更為「即時」。在此狀態下，您將無法編輯歷程。 | <ul><li>重複 </li><li>不接受新進入歷程 </li><li>中止 </li></ul> |
| _**不接受新進入歷程**_ | 當您在頂端導覽區域按一下「[!UICONTROL 不接受新進入歷程]」，此歷程狀態會從「_即時_」變更為「_不接受新進入歷程_」。 | <ul><li>重複 </li><li>中止 </li></ul> |
| _**已中止**_ | 當您中止歷程時，歷程狀態會從「_即時_」或「_不接受新進入歷程_」發生變更。中止的歷程無法重新啟動。 | <ul><li>重複 </li><li>刪除 </li></ul> |
| _**已完成**_ | 當歷程中的所有帳戶均完成此歷程時，其狀態會從「即時」或「不接受新進入歷程」變更為「已完成」。 | <ul><li>重複 </li><li>刪除 </li></ul> |
