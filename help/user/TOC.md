...
+ AI小幫手{#ai-assistant} {#ai-assistant}
...
+ 歷程內容{#journey-content} {#journey-content}
   + 電子郵件頻道{#email-channel} {#email-channel}
...
+ 帳戶{#accounts} {#accounts}
   + [客群](./audiences/account-audience-overview.md)
   + 購買群組{#buying-groups} {#buying-groups}
...
+ 內容管理{#content-management} {#content-management}
   + Assets {#assets} {#assets}
      ...
      + Marketo Engage資產{#marketo-engage-dam} {#marketo-engage-dam}
...
+ 深入分析控制面板{#dashboards} {#dashboards}
