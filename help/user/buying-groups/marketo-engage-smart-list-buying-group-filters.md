...
>**功能淘汰**</br></br>
>
>在Journey Optimizer B2B Edition中，已連線的Marketo Engage執行個體中不再提供購買群組篩選器。</br></br>
>
...
身為行銷人員，您可能想要針對屬於Journey Optimizer B2B Edition中購買群組的人員，抑制其在Marketo Engage中的行銷活動。 您也可以使用與購買群組相關聯潛在客戶的相關資訊，通知Marketo Engage中的潛在客戶評分工作流程。 例如：
