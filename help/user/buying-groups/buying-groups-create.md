...
建立購買群組時，可透過[解決方案興趣](./solution-interests.md)在帳戶歷程中使用。
...
1. 選取方案興趣和帳戶對象後，按一下&#x200B;**[!UICONTROL 建立]**。

## 確認

確認對話方塊提供購買群組流程的摘要，以及預估完成時間。 若要確認並啟動程式，請按一下[建立]。****

![建立購買群組確認對話方塊](./assets/buying-groups-create-confirm.png){width="400" zoomable="no"}
