...
透過更新的架構，Journey Optimizer B2B Edition和Marketo Engage並非位於相同的系統和相同的資料存放區。 Journey Optimizer B2B Edition會從Adobe Experience Platform接收資料。 但是仍要仰賴 Marketo Engage 的權限和部分設定功能來進行系統佈建和設定。
