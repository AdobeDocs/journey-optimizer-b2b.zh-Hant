...
| 功能 | 歷程的自訂外部動作 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}開發人員現在可以使用API來建立與第一方系統的整合。 透過這些自訂整合，行銷人員可以新增&#x200B;_外部動作_&#x200B;和&#x200B;_外部分割路徑_&#x200B;節點，以在帳戶歷程執行期間對外部服務發出傳出請求。 [深入瞭解]&#x200B;(../admin/configure-external-actions.md |
