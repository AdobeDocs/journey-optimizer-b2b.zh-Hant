...
| 功能 | WhatsApp 頻道 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}行銷人員現在可以透過[!DNL Meta Cloud API]直接從帳戶歷程傳送WhatsApp訊息。 此功能可緊密整合WhatsApp傳訊功能，以支援歷程內容頻道。 [了解更多](../admin/configure-channels-whatsapp.md) |
...
| 功能 | 歷程的自訂外部動作 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}開發人員現在可以使用API來建立與第一方系統的整合。 透過這些自訂整合，行銷人員可以新增&#x200B;_外部動作_&#x200B;和&#x200B;_外部分割路徑_&#x200B;節點，以在帳戶歷程執行期間對外部服務發出傳出請求。 [了解更多](../admin/configure-external-actions.md) |
...
| 增強功能 | 傳送電子郵件 — 傳送時間最佳化 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}針對&#x200B;_在個人歷程中傳送電子郵件_&#x200B;動作節點，您可以使用&#x200B;_傳送時間最佳化_&#x200B;選項，透過預測每個設定檔最有可能參與的時間來個人化電子郵件傳送時間。 [了解更多](../content/email-send-time-optimization.md) |
...
| 增強功能 | 個人自訂物件 — 購買群組角色範本 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}管理員設定與業務人員設定檔相關的自訂物件時，行銷人員現在可以使用這些自訂物件來定義購買群組角色。 [了解更多](../buying-groups/buying-groups-role-templates.md#add-the-template-roles) |
...
| 增強功能 | (Beta)內容個人化 — 支援人員自訂物件 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}當行銷人員使用自訂物件定義內容個人化時，他們可以存取模型型類別自訂物件（關聯式結構描述）的變數。 [了解更多](../content/personalization.md#custom-datasets) |
...
| 增強功能 | 歷程&#x200B;_等待_&#x200B;節點 — 進階設定 | [!BADGE 簡化的架構]{type=Informative tooltip="提供簡化的架構"}對於歷程中的&#x200B;_等待_&#x200B;節點，行銷人員現在可以指定退出日期和時間，並選取時區。 此增強功能可讓您更妥善地控制歷程協調和行銷活動時間。 [了解更多](../journeys/wait-nodes.md#advanced-wait-settings) |
