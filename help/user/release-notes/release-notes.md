...
| 功能 | 啟用到歷程的目的地 | 使用新的&#x200B;_啟用至目的地_&#x200B;公司帳戶動作，直接啟用至公司，而非個人。 （僅限此發行版本的LinkedIn公司使用。） |
...
| 專員 | 更新 | 說明 |
| ----- | ------ | ----------- |
| 歷程建置代理 | 新版 | Journey Build代理程式會即時分析、構想和共同建立歷程，讓行銷人員能夠更快速地啟動、改善參與度和推動更高的轉換率。 [了解更多](../agents/journey-agent.md) |
| Audience 代理 | 新版 | Audience Agent會使用結構化和非結構化資料，自動識別及建立購買群組。 它可協助行銷人員更快速、更準確地鎖定所需人員。 [了解更多](../agents/audience-agent-b2b.md) |
