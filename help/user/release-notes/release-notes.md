...
>[!NOTE]
>
>這些版本變更從2026年5月22日開始部署，並分階段推出每個功能和增強功能。 功能及增強功能的發行日期隨時可能變動。
...
## 2026.3發行說明 {#rel-2026-3}

**部署日期**：2026年3月27日

| 類型 | 項目 | 說明 |
| ---- | ---- | ----------- |
| 功能 | WhatsApp 頻道 | 行銷人員現在可以透過[!DNL Meta Cloud API]，直接從帳戶歷程傳送WhatsApp訊息。 此功能可緊密整合WhatsApp傳訊功能，以支援歷程內容頻道。 [了解更多](../admin/configure-channels-whatsapp.md) |
| 功能 | 支援[!DNL Firefly]和自訂Generative AI模型 | 行銷團隊現在可以啟用標準與自訂[!DNL Firefly]模型，以及已核准的協力廠商影像模型（例如[!DNL NanoBanana]）的整合。 電子郵件設計人員可以針對每個使用案例選取最佳模型：適用於一般需求的標準[!DNL Firefly]、適用於品牌內產生的自訂[!DNL Firefly]，或適用於特殊或實驗性案例的已核准協力廠商模型。 [了解更多](../content/generative-ai-models.md) |
| 功能 | 歷程的自訂外部動作 | 開發人員現在可以使用API來建立與第一方系統的整合。 透過這些自訂整合，行銷人員可以新增&#x200B;_外部動作_&#x200B;和&#x200B;_外部分割路徑_&#x200B;節點，以在帳戶歷程執行期間對外部服務發出傳出請求。 [了解更多](../admin/configure-external-actions.md) |
| 功能 | 品牌 | (Beta)行銷團隊可以透過儲存和管理品牌設定檔，維護其電子郵件內容資產中的品牌一致性。 透過新增資產（例如顏色、字型、標誌、主題、視覺內容和法規遵循指南），他們可以使用品牌設定檔來建立創作AI內容。 他們也可以衡量品牌一致性，以確保符合規定。 [了解更多](../content/brands-overview.md) |
| 增強功能 | 傳送電子郵件 — 傳送時間最佳化 | 針對&#x200B;_在個人歷程中傳送電子郵件_&#x200B;動作節點，您可以使用&#x200B;_傳送時間最佳化_&#x200B;選項，透過預測每個設定檔最有可能參與的時間來個人化電子郵件傳送時間。 [了解更多](../content/email-send-time-optimization.md) |
| 增強功能 | 電子郵件範本設計工具 — 進階HTML模式 | 在電子郵件範本設計空間中使用&#x200B;_進階HTML模式_，使用者可以進行細微的HTML/CSS編輯，並將指令碼標籤新增至電子郵件範本，以解決轉譯問題。 [了解更多](../content/email-template-advanced-html.md) |
| 增強功能 | 個人自訂物件 — 購買群組角色範本 | 管理員設定與企業人員個人檔案相關的自訂物件時，行銷人員現在可以使用這些自訂物件來定義購買群組角色。 [了解更多](../buying-groups/buying-groups-role-templates.md#add-the-template-roles) |
| 增強功能 | 電子郵件內容評分 — 內容品質評估 | 除了品牌一致性之外，您還可以評估整體內容品質，以找出可讀性、一致性和有效性方面的潛在問題（不受品牌指南影響）。 這些自動化檢查有助於識別不清楚的訊息、不一致的語調或結構性缺口。 [了解更多](../content/content-evaluation.md) |

>[!NOTE]
>
>這些版本變更從2026年3月27日開始部署，並分階段推出每個功能和增強功能。 功能及增強功能的發行日期可能隨時變更。


## 2026.2版本注意事項 {#rel-2026-2}
...
| 增強功能 | (Beta)內容個人化 — 支援人員自訂物件 | 當行銷人員使用自訂物件定義內容個人化時，他們可以存取模型型類別自訂物件（關聯式結構描述）的變數。 [了解更多](../content/personalization.md#custom-datasets) |

>[!NOTE]
>
>這些版本變更從2026年2月20日開始部署，並分階段推出每個功能和增強功能。 功能及增強功能的發行日期可能隨時變更。

## 2026.1版本注意事項 {#rel-2026-1}
...
| 銷售限定詞 | 新版 | Sales Qualifier是Adobe Journey Optimizer B2B edition的AI驅動附加應用程式，其中包含Account Qualification Agent，旨在簡化業務開發代表(BDR)的工作流程。 它可跨管道自動化潛在客戶資格、外聯和買家參與工作流程。 [了解更多](../agents/sales-qualifier.md) |
...
| 功能 | Salesforce 和 Dynamics 的銷售洞察 | 銷售團隊成員現在可以在 Salesforce 或 Dynamics 整合中檢視成熟化的購買群組和相關洞察，來識別新的商機。 此購買群組詳細資訊（如階段、分數及相關成員）均已涵蓋在內。 [了解更多](../buying-groups/incrm-insights.md) |
| 功能 | 啟用對象至[!DNL Adobe Target] | 您現在可以從帳戶歷程中啟用對象至外部客戶對象，並將其推送到[!DNL Adobe Target]。 透過這項整合，您可以透過歷程式列傳送符合在[!DNL Target]中設計的網頁體驗的對象。 [了解更多](../audiences/target-external-audience.md) |
...
| 增強功能 | 改善購買群組完整性評分 | 您現在可以自訂用於完整性評分的角色成員臨界值，確保購買群組反映真正的決策。  [了解更多](../buying-groups/completeness-scores.md) |
| 增強功能 | 購買群組維護工作 | 購買群組維護工作的頻率已從每週變更為每日。 |
...
>[!NOTE]
>
>檢閱[設定檢查清單](../setup-ultimate.md)以取得設定指南。

2025.10版本提供下列新功能和增強功能，以及更新的架構：
...
| 增強功能 | 參與度分數更新 | 購買群組參與度分數邏輯已更新，以將分數標準化。 此外，也可以使用會員等級參與度分數，以及整個購買群組的集體參與度分數。 [了解更多](../buying-groups/engagement-scores.md) |
| 增強功能 | 使用中的歷程可觀察性－每個節點的帳戶 | 針對使用中的帳戶歷程，您可以存取已達歷程中每個帳戶節點的帳戶清單。 |

## 2025.6 發行說明 {#rel-2025-6}
...
| 功能 | 人員詳細資料頁面 | 使用者現在可以在個人名稱顯示在「智慧型儀表板」、購買群組詳細資訊頁面和帳戶詳細資訊頁面中時（超連結），按一下該名稱。 此動作會開啟關聯人員詳細資訊頁面，其中包含連絡人、其活動以及最常參與之購買群組的資訊。 [了解更多](../accounts/person-details.md) |
| 功能 | 帳戶和購買群組動作 | 直接從帳戶詳細資料和購買群組詳細資料頁面採取行動，以利及時進行刻意的參與。 <li>使用&#x200B;_傳送電子郵件_&#x200B;動作將已核准的 Marketo Engage 電子郵件傳送給所選取的帳戶聯絡人或購買群組成員。 [了解更多](../accounts/account-details.md#send-email) <li>在購買群組詳細資料中，可採取的動作也包括&#x200B;_指派新成員_、_移除成員_&#x200B;和&#x200B;_編輯角色_。 [了解更多](../buying-groups/buying-group-details.md#members-tab) |
...
| 增強功能 | 電子郵件的 Handlebar 語彙基元格式 | 電子郵件內容的個人化語彙基元現在使用了與 Handlebar 指令碼完全相容的更新格式。 此格式採用&#x200B;_駝峰式大小寫_&#x200B;或底線，排除了空格。 [了解更多](../content/email-authoring.md#personalize-content) |
| 增強功能 | 清單的顯示總數 | 「_[!UICONTROL 解決方案興趣]_」和「_[!UICONTROL 帳戶歷程]_」清單頁面現在會在搜尋列旁邊顯示總數，讓功能更加完善。 |

## 2025.4 發行說明 {#rel-2025-4}
...
| 功能 | 刪除購買群組階段 | 您可以刪除處於草稿或已發佈狀態的購買群組階段模型。 若購買群組階段模型是已發佈 (上線) 狀態，則唯有在其未與解決方案興趣相關聯時，才能刪除。 <a href="../buying-groups/buying-group-stages.md#delete-the-buying-group-stages-model">了解更多</a> |
...
| 功能 | 購買群組和帳戶詳細資訊 | 檢視購買群組和帳戶層級的洞察，以便在開始與客戶互動時掌握更多背景和歷史資料。<p>購買群組詳細資訊包括已偵測到的任何第一方意圖。 <a href="../buying-groups/buying-group-details.md">了解更多</a><p>帳戶詳細資訊頁面會醒目顯示偵測到參與激增的意圖，以便行銷人員可以提醒銷售人員哪些帳戶已準備好進行以自訂銷售為中心的參與。  <a href="../accounts/account-details.md">了解更多</a> |
| 功能 | 歷程概觀儀表板 | 針對帳戶歷程，**[!UICONTROL 概觀]**&#x200B;索引標籤會提供您作用中歷程的完整快照，包含圓圈和長條圖，可分類和量化完成和參與活動。 <a href="../dashboards/journeys-dashboard.md">了解更多</a> |
...
| 功能 | 歷程中&#x200B;_新增至清單_&#x200B;和&#x200B;_從清單中刪除_&#x200B;的人員動作 | 使用歷程動作，在連線的Marketo Engage執行個體中，透過協調您的帳戶歷程協調，將人員新增至靜態清單或從中移除人員。 <a href="../journeys/action-nodes.md">了解更多</a> |
...
| 功能 | 購買群組階段 | 當您定義並發佈自訂購買群組階段模型時，您可以追蹤購買群組在購買群組生命週期各階段中的進展。 使用這些階段來確定購買群組成員的下一步最佳行動。 您可以設定轉換規則和歷程節點，以判斷階段進度並根據變更觸發動作。 <a href="../buying-groups/buying-group-stages.md">了解更多</a> |
...
| 功能 | 最近存取的資產 | Journey Optimizer B2B Edition 應用程式中的首頁現在包括「_[!UICONTROL 最近存取]_」區段，為行銷人員或管理員提供最近存取的資產清單。 您可以使用此清單直接前往最近處理的資產，不需要導覽一系列的資產頁面及搜尋。 <p>此清單提供有關修改的其他資訊，以便您判斷自上一個工作階段以來哪些資產需要進一步修改。 針對電子郵件資產，它顯示使用電子郵件資產的帳戶歷程。 <a href="../home-page.md">了解更多</a> |
| 增強功能 | 歷程分割節點 - 重新排序路徑 | 分割路徑節點中的路徑篩選會由上而下進行評估。 每位人員或每個帳戶均按照相符的第一條路徑前進。 您可以透過點按每個路徑卡片右上角的向上鍵和向下鍵來重新排序已定義的路徑，在清單中向上或向下移動。 <a href="../journeys/split-merge-paths-nodes.md#split-paths">了解更多</a> |
| 增強功能 | 歷程分割節點 - 其他活動歷史條件屬性 | 當使用條件來定義根據人員分割路徑的路徑篩選時，有兩種附加屬性：_已開啟電子郵件_&#x200B;和&#x200B;_已傳送電子郵件_。 這些新增內容提供更大的彈性，可根據電子郵件活動篩選歷程中的人員。 <a href="../journeys/split-merge-paths-nodes.md#split-paths-by-accounts">了解更多</a> |
...
| 類型 | 項目 | 說明 |
| ---- | ---- | ----------- |
| 功能 | LinkedIn 帳戶配對客群 | 透過帳號配對客群產生 LinkedIn 廣告客群，以協助您填入購買群組中的空白角色。 透過定義一組購買群組篩選器，您可以維護 LinkedIn 配對客群，以針對符合您的購買群組參數的潛在客戶。 <p>此功能善用 Experience Platform 目標來管理整合的某些部分。 <a href="../data/linkedin-account-matched-audiences.md">了解更多</a> |
